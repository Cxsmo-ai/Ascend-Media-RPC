...
async function fetchState() {
    try {
        ...
        if (data.config && !configLoaded) {
            ...
            if (document.getElementById("chk-desktop-mode")) {
                document.getElementById("chk-desktop-mode").checked = data.config.stremio_desktop_enabled;
            }
            configLoaded = true;
        }
...
async function saveSettings(action) {
    const payload = {
        ...
        stremio_desktop_enabled: document.getElementById("chk-desktop-mode") ? document.getElementById("chk-desktop-mode").checked : false
    };
